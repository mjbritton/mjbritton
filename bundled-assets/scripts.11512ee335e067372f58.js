!(function(e) {
	function t(t) {
		for (var r, l, c = t[0], i = t[1], a = t[2], p = 0, s = []; p < c.length; p++)
			(l = c[p]), Object.prototype.hasOwnProperty.call(o, l) && o[l] && s.push(o[l][0]), (o[l] = 0);
	...
	(l.m = e),
		...
		(l.p = '/wp-content/themes/mjbritton/bundled-assets/');
