...
function theme_files()
{
    ...
    if (strstr($_SERVER['SERVER_NAME'], 'mjbritton.local')) {
        ...
        wp_enqueue_script('main-theme-js', get_theme_file_uri('/bundled-assets/scripts.87aa60741b474b705898.js'), null, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.776336e61c5913b96871.css'));
    }
