...
function theme_files() {
  ...
  if (strstr($_SERVER['SERVER_NAME'], 'mjbritton.local')) {
    ...
    wp_enqueue_script('main-theme-js', get_theme_file_uri('/bundled-assets/scripts.25a62d9e329eed25d4d9.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.25a62d9e329eed25d4d9.css'));
  }
