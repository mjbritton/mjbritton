...
<div class="container">
    <div class="holding-page__content">
        ...
        <a class="holding-page__link" href="mailto:hello@mjbritton.co.uk"><span class="holding-page__button animation__heartbeat"><?php echo file_get_contents( get_stylesheet_directory_uri() . '/images/icons/envelope.svg' ); ?></span></a>
    </div>
</div>
